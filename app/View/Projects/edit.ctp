...
<?php echo $this->Form->create('Project'); ?>
	...
	<?php
		echo $this->Form->input('idProyectos');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Project.idProyectos')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Project.idProyectos')))); ?></li>
