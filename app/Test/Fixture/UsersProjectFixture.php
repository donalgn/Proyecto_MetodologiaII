 ...
 */
	public $fields = array(
		...
		'enable' => array('type' => 'string', 'null' => false, 'default' => 'Y', 'length' => 1, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'),
		'indexes' => array(
			'PRIMARY' => array('column' => array('user_project_id', 'project_id', 'user_id'), 'unique' => 1),
			'fk_project_user_user_idx' => array('column' => 'user_id', 'unique' => 0),
			'fk_project_user_project_idx' => array('column' => 'project_id', 'unique' => 0)
		),
 ...
 */
	public $records = array(
		array(
			...
			'project_id' => 1,
			'user_id' => 1,
			'enable' => 'Lorem ipsum dolor sit ame'
		),
	);
